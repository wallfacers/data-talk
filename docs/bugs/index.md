...
| [BUG-0058](BUG-0058-file-read-image-no-compression-base64-too-large.md) | datatalk_file_read 对图片直接 base64，截图触发"payload 太大" | verified | 2026-05-18 | pending |
...
- **opencode**: [BUG-0036](BUG-0036-skills-extracted-to-wrong-cwd-not-found-by-opencode.md) *(fixed)*, [BUG-0040](BUG-0040-agents-md-skill-path-triggers-llm-hallucination.md) *(fixed)*, [BUG-0049](BUG-0049-bezel-dashboard-html-chinese-garbled.md), [BUG-0058](BUG-0058-file-read-image-no-compression-base64-too-large.md) *(verified)*
