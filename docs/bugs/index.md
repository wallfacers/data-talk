...
| ID | Title | Status | Priority | Owner |
|----|-------|--------|----------|-------|
| [BUG-0089](BUG-0089-chart-block-collapses-to-dedup-hint-after-self-promote.md) | 点击"打开到工作台"后 ChartBlock 误塌缩为"已在上方图表产物中展示"，实际上方无产物卡片（BUG-0064 去重回归） | fixed | P2 | — (pending) |
| [BUG-0087](BUG-0087-tauri-resource-dir-extended-path-prefix-crashes-java.md) | Tauri resource_dir() 返回 \\?\ 扩展路径前缀导致 bundled Java 启动崩溃 | fixed | P0 | — (pending) |
...
- **opencode**: [BUG-0036](BUG-0036-skills-extracted-to-wrong-cwd-not-found-by-opencode.md) *(fixed)*, [BUG-0040](BUG-0040-agents-md-skill-path-triggers-llm-hallucination.md) *(fixed)*, [BUG-0049](BUG-0049-bezel-dashboard-html-chinese-garbled.md), [BUG-0058](BUG-0058-file-read-image-no-compression-base64-too-large.md) *(fixed)*, [BUG-0065](BUG-0065-pre-action-protocol-bypassed-via-ui-exec-path.md) *(fixed)*, [BUG-0088](BUG-0088-empty-ai-model-prefs-causes-providermodelnotfounderror.md)
