...
- **bezel-compiler**: [BUG-0081](BUG-0081-bezel-csp-blocks-inline-scripts.md) *(fixed)*, [BUG-0082](BUG-0082-bezel-scheduler-polls-get-but-endpoint-is-post.md) *(fixed)*, [BUG-0083](BUG-0083-bezel-dashboard-data-never-loads-no-initial-fetch.md) *(fixed)*, [BUG-0084](BUG-0084-bezel-incremental-hot-update-unwired.md) *(fixed)*
...
- **e2e-playwright (question-tool-bridge)**: [BUG-0080](BUG-0080-question-tool-renderer-not-registered.md) *(fixed)*
