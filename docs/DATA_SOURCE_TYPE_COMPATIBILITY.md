...
| C — domestic / enterprise compatibility | `gaussdb`, `opengauss`, `dameng` / `dm` / `dm8`, `kingbase` / `kingbasees`, `oceanbase`, `tidb` | Wave C step 1 (`tidb`) completed 2026-05-08, step 2 (`opengauss`) completed 2026-05-09, step 3 (`oceanbase`) completed 2026-05-09, step 4 (`kingbase`) completed 2026-05-09, step 5 (`dameng`) completed 2026-05-09. Remaining C-band candidates: `gaussdb`. Do not assume PostgreSQL/MySQL compatibility is enough. Each kind needs explicit driver, URL, catalog/schema, SQL dialect, and risk-analysis decisions. |
