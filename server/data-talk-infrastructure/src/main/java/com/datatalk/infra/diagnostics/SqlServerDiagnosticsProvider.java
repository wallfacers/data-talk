...
/**
 * SQL Server diagnostics provider. Day-1: all capabilities are structured unsupported.
 * Future: implement EXPLAIN (SHOWPLAN), index hints, lock info, pool status, etc.
 */
@Component
public class SqlServerDiagnosticsProvider extends AbstractDiagnosticsProvider {
    ...
    public Set<DiagnosticCapability> supportedCapabilities() {
        // Day-1: no capabilities supported
        return Set.of();
    }
