...
public class DefaultSqlStatementSplitters implements SqlStatementSplitters {
    ...
    public List<String> split(String connectionKind, String sql) {
        if ("postgres".equalsIgnoreCase(connectionKind) || "postgresql".equalsIgnoreCase(connectionKind) || "kingbase".equalsIgnoreCase(connectionKind) || "gaussdb".equalsIgnoreCase(connectionKind)) {
