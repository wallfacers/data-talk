    ...
    public Map<String, Object> propertySchema() {
        return Map.of(
            ...
            "properties", Map.ofEntries(
                ...
                Map.entry("kind",         Map.of("type", "string", "enum", List.of("mysql", "postgresql", "sqlite", "h2", "mariadb", "tidb", "oceanbase", "oracle", "sqlserver", "duckdb", "clickhouse", "apache_doris", "starrocks", "trino", "presto", "hive", "dameng", "kingbase"))),
