...
class UseTargetResolverTest {
    ...
    void setUp() throws Exception {
        ...
        connectionRepo.insert(new ConnectionRecord("c1", "主库", "h2", "localhost", 0, "app_db", "sa", new byte[]{1}, null, 1L, 3000, null, null, null, 1, true, null, false, null, null, null));
        connectionRepo.insert(new ConnectionRecord("c2", "analytics", "h2", "localhost", 0, "analytics_db", "sa", new byte[]{1}, null, 1L, 3000, null, null, null, 1, true, null, false, null, null, null));
