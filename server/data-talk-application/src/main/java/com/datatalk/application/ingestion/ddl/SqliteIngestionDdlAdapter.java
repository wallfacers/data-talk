...
@Component
public class SqliteIngestionDdlAdapter implements IngestionDdlAdapter {

    @Override
    public boolean supports(String connectionKind) {
        return "sqlite".equalsIgnoreCase(connectionKind);
    }
    ...
    public String sqlTypeFor(InferredType inferred) {
        return switch (inferred) {
            ...
            case INTEGER_64 -> "INTEGER";
            case DECIMAL -> "NUMERIC";
            case DATE -> "TEXT";
            case TIMESTAMP -> "TEXT";
            case STRING_64 -> "TEXT";
            case STRING_256 -> "TEXT";
            case STRING_500 -> "TEXT";
