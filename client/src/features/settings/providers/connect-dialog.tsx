...
type Props = { providerId: string; providerName: string; onCancel: () => void; onSaved: () => void }

export function ConnectPanel({ providerId, providerName, onCancel, onSaved }: Props) {
  ...
  return (
    <div className="rounded-lg border bg-card p-6">
      <h2 className="mb-4 text-lg font-medium">连接 {providerName}</h2>
