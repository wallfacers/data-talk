...
import { DatabaseIcon, EllipsisVerticalIcon, Settings2Icon, SlidersHorizontalIcon, BoxIcon, WrenchIcon, KeyRound } from 'lucide-react'
  ...
  const groups = [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'credentials', label: t('settings.credentials'), icon: KeyRound, section: 'credentials' as const },
